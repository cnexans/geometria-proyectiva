...
\textbf{LiDAR} (conjunto \emph{PandaSet})\footnote{Demo en vivo:
\url{https://demo-lidar.cnexans.com}. Código:
\url{https://github.com/cnexans/demo-visualizacion-lidar-webgl}.}, construido
...
\item Proyecto propio. \emph{demo-visualizacion-lidar-webgl}: visor LiDAR
  para conducción autónoma. Demo en vivo:
  \url{https://demo-lidar.cnexans.com}. Código:
  \url{https://github.com/cnexans/demo-visualizacion-lidar-webgl}
\end{itemize}
