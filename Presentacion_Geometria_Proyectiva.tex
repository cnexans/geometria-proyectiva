  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.54\textwidth}
      ...
      \begin{tikzpicture}[scale=1.0,>=Latex,line cap=round]
        % --- plano imagen (2D) ---
        \draw[azul,thick,fill=hielo] (-3.2,-1.0) -- (-2.2,-1.4)
              -- (-2.2,1.0) -- (-3.2,1.4) -- cycle;
        \node[azul,font=\footnotesize] at (-2.7,-1.85) {plano 2D};
        % --- centro óptico ---
        \fill[navy] (-1.3,0) circle (1.6pt);
        \node[navy,font=\scriptsize,above] at (-1.3,0.08) {$O$};
        % --- escena 3D (cubo en perspectiva) ---
        \begin{scope}[shift={(1.7,0)}]
          \draw[gris,thick] (0,-0.6) -- (1.2,-0.6) -- (1.2,0.6) -- (0,0.6) -- cycle;
          \draw[gris,thick] (0.5,-0.2) -- (1.7,-0.2) -- (1.7,1.0) -- (0.5,1.0) -- cycle;
          \draw[gris,thick] (0,-0.6) -- (0.5,-0.2);
          \draw[gris,thick] (1.2,-0.6) -- (1.7,-0.2);
          \draw[gris,thick] (1.2,0.6) -- (1.7,1.0);
          \draw[gris,thick] (0,0.6) -- (0.5,1.0);
        \end{scope}
        \node[gris,font=\footnotesize] at (2.6,-1.0) {escena 3D};
        % --- rayos de proyección por O ---
        \foreach \py/\iy in {0.6/0.72, -0.6/-0.62, 1.0/0.95} {
          \draw[oro,thin,opacity=0.85] (1.7,\py) -- (-1.3,0);
          \fill[rojo] (-2.46,{\iy*0.62}) circle (1.0pt);
        }
        % --- flechas de doble sentido ---
        \draw[->,azul,thick] (-0.55,1.55) .. controls (0.4,1.95) .. (1.4,1.6)
              node[midway,above,font=\scriptsize,azul]{cámara: $3$D\,$\to$\,$2$D};
        \draw[->,verde!60!black,thick] (1.4,-1.75) .. controls (0.4,-2.15) .. (-0.55,-1.75)
